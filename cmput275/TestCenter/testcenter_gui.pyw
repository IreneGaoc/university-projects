...
class Application(ttk.Frame):
    ...
    def createWidgets(self):
        ...
        self.sb2.set_data("")
        self.sb1 = MyStatusBar(self,"Tests: %s   Errors: %s   Soft-test fails: %s   Hard-test fails: %s")
    ...
    def runall(self):
        if self.runall_enabled():
            try:
                ...
                self.test_suite.run_tests(self.script_dir,timeout=500,gen_res=False,visible_space_diff=True,verbose =True)
